  ...
  return (
    <div className="bot-ui p-4 max-w-md mx-auto sm:max-w-sm md:max-w-md">
      ...
      <div className="bg-gray-800 rounded-xl m-5 text-white p-6 flex flex-col items-center gap-5">
        <button
          onClick={handleTap}
          className="mt-4 w-32 h-32 sm:w-40 sm:h-40 bg-yellow-400 rounded-full flex items-center justify-center text-white text-lg font-bold shadow-lg relative"
        >
          <span className="absolute inset-0 flex items-center justify-center">
            <span className="block w-16 h-16 sm:w-20 sm:h-20 bg-yellow-300 rounded-full"></span>
          </span>
          <span className="absolute inset-0 flex items-center justify-center">
            <span className="block w-24 h-24 sm:w-32 sm:h-32 bg-yellow-400 rounded-full border-4 border-yellow-600"></span>
          </span>
          <span className="absolute inset-0 flex items-center justify-center">
            {/* Image here */}
          </span>
